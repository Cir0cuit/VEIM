...
OFFICIAL = [
    ...
    ("Fedora-Server-netinst-x86_64-44-1.7.iso", "fedora", "server-netinst", "44"),
    ("Fedora-IoT-ostree-44-20260427.0.x86_64.iso", "fedora", "iot", "44 (20260427.0)"),
    ("Fedora-Cinnamon-Live-44-1.7.x86_64.iso", "fedora_spins", "cinnamon", "44"),
    ("Fedora-MATE_Compiz-Live-44-1.7.x86_64.iso", "fedora_spins", "mate", "44"),
    ...
    ("ubuntukylin-26.04.1-desktop-amd64.iso", "ubuntu", "kylin", "26.04.1"),
    ("debian-live-13.7.0-amd64-lxqt.iso", "debian", "lxqt", "13.7.0"),
    ("kali-linux-2026.2-installer-netinst-amd64.iso", "kali", "netinst", "2026.2"),
    ("alpine-virt-3.24.2-x86_64.iso", "alpine", "virt", "3.24.2"),
    ("garuda-hyprland-linux-garuda-260819.iso", "garuda", "hyprland", "260819"),
    ("sparkylinux-2026.06-x86_64-gameover.iso", "sparky", "rolling-gameover", "2026.06"),
    ("sparkylinux-2026.06-x86_64-xfce.iso", "sparky", "rolling-xfce", "2026.06"),
    ("TinyCorePure64-16.2.iso", "tinycore", "tinycorepure64", "16.2"),
    ("Core-17.1.iso", "tinycore", "core", "17.1"),
    ("proxmox-backup-server_4.2-1.iso", "proxmox", "backup-server", "4.2-1"),
    ("proxmox-mail-gateway_9.1-1.iso", "proxmox", "mail-gateway", "9.1-1"),
    ("proxmox-datacenter-manager_1.1-1.iso", "proxmox", "datacenter-manager", "1.1-1"),
    ("linux-lite-8.0-64bit.iso", "linuxlite", "standard", "8.0"),
    ("FreeBSD-15.1-RELEASE-amd64-disc1.iso", "freebsd", "disc1", "15.1"),
    ("ipfire-2.29-core203-x86_64.iso", "ipfire", "standard", "2.29 Core 203"),
    ("OracleLinux-R10-U2-x86_64-dvd.iso", "oracle", "dvd", "10.2"),
    ("talos-1.14.1-metal-amd64.iso", "talos", "metal", "1.14.1"),
    ...
    ("Leap-16.0-offline-installer-x86_64-Build178.27.install.iso", "opensuse", "leap-dvd",
     "16.0 (Build 178.27)"),
    ("Leap-16.0-online-installer-x86_64-Build178.27.install.iso", "opensuse", "leap-net",
     "16.0 (Build 178.27)"),
    ("openSUSE-Tumbleweed-KDE-Live-x86_64-Snapshot20260919-Media.iso", "opensuse",
     "tumbleweed-kde", "20260919"),
    ("openSUSE-Tumbleweed-NET-x86_64-Snapshot20260919-Media.iso", "opensuse",
     "tumbleweed-net", "20260919"),
    ("nixos-minimal-26.05.10304.6d663c0533ff-x86_64-linux.iso", "nixos", "minimal", "26.05.10304"),
    ("Rocky-10.2-x86_64-dvd1.iso", "rocky", "dvd", "10.2"),
